...
public class JavaCVCamShift2 {
	...
	public JavaCVCamShift2() {
		...
		while (true) {
			...
			// track_object非零,表示有需要跟踪的物体
			{
				...
				cvRectangle(frame, cvPoint(0, 0), cvPoint(550, 50),
						CV_RGB(255, 255, 255), 1, CV_AA, 0);
				cvRectangle(frame, cvPoint(100, 100), cvPoint(800, 150),
						CV_RGB(255, 255, 255), 1, CV_AA, 0);
				cvRectangle(frame, cvPoint(0, 200), cvPoint(550, 250),
						CV_RGB(255, 255, 255), 1, CV_AA, 0);
				cvRectangle(frame, cvPoint(100, 300), cvPoint(800, 350),
						CV_RGB(255, 255, 255), 1, CV_AA, 0);
				cvRectangle(frame,cvPoint(550,350),cvPoint(800,800),CV_RGB(0,0,255),1,CV_AA,0);
				cvRectangle(
						frame,
				...
				if ((x >= 0 && x <= 550) && (y >= 0 && y <= 50)){
					System.out.println("error!!");
				}
				if ((x >= 100 && x <= 800) && (y >= 100 && y <= 150)){
					System.out.println("error!!");
				}
				if ((x >= 100 && x <= 800) && (y >= 300 && y <= 350)){
					System.out.println("error!!");
				}
				if ((x >= 0 && x <= 550) && (y >= 200 && y <= 250)){
					System.out.println("error!!");
				}
				if ((x >= 0&& x <= 50) && (y >= 400 && y <= 800)){
	...
	public static void main(String[] args) {
		...
		// new JavaCVCamShift();
		JavaCVCamShift2 a1 = new JavaCVCamShift2();
